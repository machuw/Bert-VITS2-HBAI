...
@click.option("--train-path", default="filelists/honkai.train.enzh.list")
@click.option("--val-path", default="filelists/honkai.val.enzh.list")
@click.option(
    "--config-path",
    default="configs/config.honkai.enzh.json",
